...
public class WeatherPressureComparatorTest {
	
	@Test
	public void testFirstHigherValuePressure() {
	...
	@Test
	public void testSamePressure() {
		WeatherReading weather1 = new WeatherReading(LocalDateTime.of(2019,12,16,01,17,27), "CH", new City(6345, "Zug"), 8.52f, 47.17f, 2657908, "Clouds", "few clouds", 5.0f, 1012, 100, 3.4f,160.0f);
		WeatherReading weather2 = new WeatherReading(LocalDateTime.of(2019,12,16,03,17,27), "CH", new City(6345, "Zug"), 8.52f, 47.17f, 2657908, "Clouds", "few clouds", 7.0f, 1012, 100, 5.4f,145.0f);
		WeatherPressureComparator comparator = new WeatherPressureComparator();
		int result = comparator.compare(weather1, weather2);
	...
	@Test
	public void testSecondHigherValuePressure() {
		WeatherReading weather1 = new WeatherReading(LocalDateTime.of(2019,12,16,01,17,27), "CH", new City(6345, "Zug"), 8.52f, 47.17f, 2657908, "Clouds", "few clouds", 5.0f, 1012, 100, 3.4f,160.0f);
		WeatherReading weather2 = new WeatherReading(LocalDateTime.of(2019,12,16,03,17,27), "CH", new City(6345, "Zug"), 8.52f, 47.17f, 2657908, "Clouds", "few clouds", 7.0f, 1050, 100, 5.4f,145.0f);
		WeatherPressureComparator comparator = new WeatherPressureComparator();
		int result = comparator.compare(weather1, weather2);
		assertEquals(result, -1);
	}
